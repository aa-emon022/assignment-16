  ...
  return (
    <>
      ...
      <section>
        ...
        <div className="grid grid-cols-2  gap-3  ml-[3rem] mr-[3rem]">
          {AllService.map((items, index) => (
            <div
              key={index}
              className="h-[24rem] lg:h-[28rem] p-[2rem] shadow-md mb-[3rem]"
            >
              <Image src={items.image} width={500} height={500} />
              <p className="pt-[2rem] text-[1.4rem] font-bold overflow-clip">
                {" "}
                {items.title}
              </p>
            </div>
