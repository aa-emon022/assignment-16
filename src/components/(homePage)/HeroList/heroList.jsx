      ...
      <div className="h-[837px] bg-[#D7F5DC] ">
        ...
        <div className=" grid grid-cols-2 gap-1">
          <div className="xl:w-[25rem] ml-[4rem] ">
            <div>
              <h1 style={headerStyle} className="text-[3rem]">
          ...
          <div className="flex  gap-4 ">
            <div className=" flex flex-col gap-4 ">
              <Image className="rounded-[10%]" src={HeroListData.image3} width={200} height={100} />
              <Image className="rounded-[10%]" src={HeroListData.image1} width={200} height={100} />
              </div>
              <div className="flex flex-col gap-4 ">
              <Image className="rounded-[10%]" src={HeroListData.image4} width={200} height={100} />
              <Image className="rounded-[10%]" src={HeroListData.image2} width={200} height={100} />
            </div>
          </div>
        </div>
